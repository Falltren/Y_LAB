...
public class Message {
    ...
    public static final String USER_MENU = "Действия пользователя:" + "\n"
            ...
            + "4 - Просмотреть статистику по тренировкам" + "\n"
            + "5 - Посмотреть статистику по затраченным калориям" + "\n"
            + "0 - Выход из меню";
    ...
    public static final String USER_EXIST = "Пользователь с таким именем уже существует, введите новое имя";
}
